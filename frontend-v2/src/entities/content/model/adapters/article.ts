...
const ARTICLE_EXCLUDE_PATTERNS = [
  /youtube\.com/,
  /youtu\.be/,
];
...
export const ArticleAdapter: SourceAdapter<{ url: string; title?: string; metadata?: ContentMetadata }> = {
  sourceType: 'article',
  ...
  toEntity(raw: { url: string; title?: string; metadata?: ContentMetadata }, userId: string): ContentEntity {
