...
export function CTASection() {
  ...
  return (
    <section className="py-20 md:py-28 text-primary-foreground relative overflow-hidden bg-foreground">
      <div className="relative mx-auto max-w-3xl px-4 text-center" ref={sectionRef}>
        ...
        <p className="reveal reveal-delay-1 mt-4 text-lg text-primary-foreground/70">
        ...
        {/* Trust badges */}
        <div className="reveal reveal-delay-3 mt-8 flex items-center justify-center gap-6 text-sm text-primary-foreground/60">
