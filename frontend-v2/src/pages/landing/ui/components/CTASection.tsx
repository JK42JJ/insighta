...
export function CTASection({ onLogin }: { onLogin: () => void }) {
  return (
      ...
      <div className="relative z-10 flex items-center justify-center gap-6 self-stretch border-t border-b px-6 py-12 md:px-24 md:py-12">
        ...
        <div className="absolute inset-0 h-full w-full overflow-hidden">
          <div
            ...
            style={{
              background:
                'linear-gradient(to bottom, var(--background) 0%, var(--background) 40%, rgba(255,255,255,0) 100%), radial-gradient(ellipse at 50% 120%, hsl(var(--primary)) 0%, var(--background) 70%)',
            }}
          >
            <div
              style={{
                ...
                backgroundImage:
                  'repeating-conic-gradient(from 0deg at 50% 100%, hsl(var(--muted)) 0deg, hsl(var(--muted)) 2deg, transparent 2deg, transparent 10deg)',
                bottom: '-20%',
                height: '100%',
                left: '50%',
                maskImage:
        ...
        <div className="relative z-20 flex w-full max-w-3xl flex-col items-center justify-start gap-6 overflow-hidden px-6 py-5 md:py-8">
          <div className="flex flex-col items-start justify-start gap-3 self-stretch">
            ...
            <div className="text-muted-foreground self-stretch text-center text-base leading-7 font-medium">
              Start building your Mandala today.
              <br />
              Free to use, forever.
            </div>
          </div>
