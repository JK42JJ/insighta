...
React 18 / Fastify / TypeScript · Supabase Cloud (PostgreSQL + pgvector + Auth + Edge Functions) · Redis · Anthropic Claude / Google Gemini / OpenRouter · AWS EC2 + Docker + Nginx · Mac Mini worker (youtube-transcript-api + claude -p, Tailscale-bound)
