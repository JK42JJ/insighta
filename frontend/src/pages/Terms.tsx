  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-8 max-w-3xl mx-auto">
      ...
      <section className="mb-6">
        ...
        <p>
          The Service accesses YouTube data through the YouTube API Services. By using this feature,
      ...
      <section className="mb-6">
        ...
        <p>
          Content you create (notes, cards) remains yours. YouTube content displayed in the Service
          belongs to its respective creators and is subject to YouTube&apos;s terms.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          stop using the Service at any time by disconnecting your accounts and deleting your data.
        </p>
      </section>
