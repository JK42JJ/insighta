      ...
      <div className="relative z-10">
        ...
        <main className="py-10 md:py-16">
          ...
          <div className="mx-auto max-w-3xl px-4 text-center">
            ...
            <h1 className="text-3xl md:text-5xl font-bold tracking-tight">{t('pricing.title')}</h1>
            ...
            <div className="rounded-xl bg-card/80 backdrop-blur-sm border border-border/50 p-4">
              <div className="flex items-center justify-between text-sm mb-2">
                <span className="font-medium">
                  {t('pricing.spotsLeft', { count: SPOTS_REMAINING })}
                </span>
                <span className="text-muted-foreground">
                  {SPOTS_TAKEN_PERCENT}% {t('pricing.claimed')}
                </span>
              </div>
            ...
            <div className="relative rounded-2xl bg-gradient-to-b from-border/60 via-border/30 to-transparent p-[1.5px] flex flex-col">
              <div className="rounded-[calc(1rem-1.5px)] bg-card p-8 md:p-10 relative overflow-hidden flex flex-col flex-1">
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {(t('pricing.monthlyFeatures', { returnObjects: true }) as string[]).map(
                    (feature, i) => (
          ...
          <div className="mx-auto max-w-2xl px-4 mt-16">
            <h2 className="text-2xl font-semibold text-center mb-8">{t('pricing.compareTitle')}</h2>
            <div className="rounded-xl border border-border/50 overflow-hidden">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {(
                    t('pricing.compareRows', { returnObjects: true }) as Array<{
                      feature: string;
                      monthly: string;
                      ltd: string;
                    }>
          ...
          {/* FAQ */}
          <div className="mx-auto max-w-2xl px-4 mt-16">
            <h2 className="text-2xl font-semibold text-center mb-8">{t('pricing.faqTitle')}</h2>
