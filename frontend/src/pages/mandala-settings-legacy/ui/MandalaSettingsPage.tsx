...
export default function MandalaSettingsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        title: t('mandalaSettings.saveFailed'),
        description: t('mandalaSettings.saveFailedGeneric', {
      ...
      <main id="main-content" className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Share Settings */}
            {(() => {
              const currentMandala =
                listData?.mandalas?.find((m) => m.isDefault) ?? listData?.mandalas?.[0];
      ...
      <AlertDialog open={showTemplateConfirm} onOpenChange={setShowTemplateConfirm}>
        <AlertDialogContent className="bg-surface-mid border-border/50">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {t('mandalaSettings.overwriteDesc', {
                name: selectedTemplate
                  ? getTemplateTranslation(selectedTemplate, i18n.language).name
                  : '',
              })}
            </AlertDialogDescription>
          </AlertDialogHeader>
