  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-8 max-w-3xl mx-auto">
      ...
      <section className="mb-6">
        ...
        <p className="mt-2">
          We do <strong>not</strong> sell, share, or transmit your data to third parties. Your data
      ...
      <section className="mb-6">
        ...
        <p className="mt-2">
          We request <code>youtube.readonly</code> access to read your playlist and video metadata.
          We never modify or delete any YouTube content.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          You can disconnect your YouTube account at any time from the Settings page, which revokes
          our access and deletes stored tokens. To request full account deletion, contact us at the
          email below.
        </p>
      </section>
