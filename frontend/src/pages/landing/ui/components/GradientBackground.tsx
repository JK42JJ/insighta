...
function FrillMesh() {
  return (
    <svg className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid slice">
      ...
      <g className="opacity-[0.04] dark:opacity-[0.07]" filter="url(#blob-blur)">
        {/* Pink — top-left */}
        <circle
          cx="15%"
          cy="15%"
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 40% at 60% 40%, hsl(var(--primary)), transparent 70%)',
        }}
      />
    </>
  );
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent 0%, hsl(var(--primary) / 0.8) 30%, hsl(270 60% 60% / 0.6) 50%, hsl(210 70% 55% / 0.8) 70%, transparent 100%)',
          filter: 'blur(60px)',
          borderRadius: '50%',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent 0%, hsl(185 60% 55% / 0.7) 25%, hsl(var(--primary) / 0.5) 50%, hsl(280 50% 60% / 0.7) 75%, transparent 100%)',
          filter: 'blur(80px)',
          borderRadius: '50%',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent 0%, hsl(210 80% 60% / 0.6) 40%, hsl(340 60% 60% / 0.4) 60%, transparent 100%)',
          filter: 'blur(70px)',
          borderRadius: '50%',
        }}
      />
