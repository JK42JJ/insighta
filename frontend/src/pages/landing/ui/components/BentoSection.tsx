      ...
      <div className="border-y p-4 w-full">
        <div className="mx-auto grid w-full max-w-6xl grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-px bg-border">
          ...
          <div className="col-span-2 row-span-2 bg-background relative flex flex-col justify-between p-8">
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground mt-4 max-w-md text-sm md:text-base">
                From fleeting ideas to structured knowledge — Insighta transforms how you capture,
                organize, and act on insights.
              </p>
            </div>
          ...
          <BentoCard
            ...
            content={
              <>
                <h3 className="text-2xl font-semibold tracking-tight">Mandala Grid System</h3>
                <p className="text-muted-foreground mt-2 text-sm">
                  9 cells, infinite depth. Nest your goals into hierarchical levels that mirror how
                  your mind naturally organizes ideas.
                </p>
              </>
            }
          />
          <BentoCard
            label="Reflect"
            content={<p className="text-sm italic">"Finally, a tool that thinks the way I do."</p>}
          />
          <BentoCard
            label="Stats"
            content={
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm mt-1">Cells per Mandala</p>
              </div>
            }
            centered
          />
...
function BentoCard({
  ...
  return (
    ...
    >
      {!centered && <span className="text-muted-foreground text-sm">{label}</span>}
      <div>{content}</div>
    </div>
  );
}
